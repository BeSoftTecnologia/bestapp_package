...
/// [ApiLogs] is used to print logs during network requests.
...
class ApiLogs extends Interceptor {
  ...
  ///  dio.interceptors.add(ApiLogs(logPrint: sink.writeln));
  ///  ...
  ///  await sink.close();
  ///```
  ...
  void _printResponse(Response response) {
    _printKV(response.requestOptions.method, response.requestOptions.uri);
    _printKV('STATUS', response.statusCode);
